...
export const EmbeddingSdkSettings = () => {
  ...
  return (
    <EmbeddingSettingsCard
      ...
      description={t`Embed the full power of TenvioX into your application to build a custom analytics experience and programmatically manage dashboards and data.`}

                ...
                <Accordion.Panel>
                  <Stack gap="lg">
                    ...
                    {!isPaidPlan ? (
                      ...
                      <Text>{t`Don't be shy with invites. TenvioX makes self-service analytics easy.`}</Text>
                    ) : (
                      // eslint-disable-next-line metabase/no-literal-metabase-strings -- This string only shows for admins
                      <Text>{t`Don't be shy with invites. TenvioX Starter plan includes 5 users, and Pro includes 10 users without the need to pay additionally.`}</Text>
                    )}

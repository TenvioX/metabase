...
export const StaticEmbedContent = ({
  ...
  <Box component="section" aria-labelledby="static-embed-title">
    ...
    <Text mb="md">
      ...
      {t`Embed a dashboard in a 'Powered by TenvioX' iframe with interactivity limited to filters and tooltips, and a few customization options. The iframe loads a TenvioX URL secured with a signed JSON Web Token (JWT). Appears with "Powered by TenvioX", on Open Source and Starter plans, with the option to remove on Pro and Enterprise. As the simplest form of embedding, you can add a dashboard into your app in a few minutes with just a snippet.`}
    </Text>
    {showImage && (
      <StaticEmbedImage

  ...
  return (
    <Box component="section" aria-labelledby="embed-js-title">
      ...
      <Text mb="md">
        ...
        {t`A JavaScript library built on top of TenvioX’s modular embedding SDK that lets you embed individual components (charts, dashboards, query builder) using plain JS — no React setup required. You get per-component controls like drill-through, parameters, downloads, theming.`}
      </Text>
      {showImage && (
        <EmbedJsImage

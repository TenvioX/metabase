          ...
          <Stack gap="xs">
            ...
            <Text c="text-secondary" size="sm">
              {isSingleTable
                ...
                : /* eslint-disable-next-line metabase/no-literal-metabase-strings -- Admin settings */
                  t`If you've made changes to these tables in the underlying databases that aren't showing up in TenvioX yet, re-syncing the schemas can fix that.`}
            </Text>
          </Stack>
          ...
          <Stack gap="xs">
            ...
            <Text c="text-secondary" size="sm">
              {isSingleTable
                ...
                : /* eslint-disable-next-line metabase/no-literal-metabase-strings -- Admin settings */
                  t`TenvioX can scan the values in these tables to enable checkbox filters in dashboards and questions.`}
            </Text>
          </Stack>
